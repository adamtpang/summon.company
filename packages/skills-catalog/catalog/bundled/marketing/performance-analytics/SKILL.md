...
key: paperclipai/bundled/marketing/performance-analytics
recommendedForRoles:
  - marketing
tags:
  - analytics
  ...
  - optimization
---
> **Source.** Adapted for Summon from the Anthropic `knowledge-work-plugins`
> marketing plugin, licensed under the Apache License 2.0. Frontmatter is
> rewritten for the Summon skills catalog; the guidance below is the
> upstream content.
