...
| 2 | **Requirements come from a PERSON, not a department.** "You must know the name of the real person who made every requirement." | Every ticket carries a named requirement owner (the board, or a named agent). "The standard requires it" is not a source; SUMMON_COMPANY_STANDARD.md cites its author (the board). |
