...
| 2026-09-17 | E18 landing perfection pass (fleet fix), branch `feat/landing-e18`, not deployed | 255 visible words, 24 links and buttons, 4 sections, 3 competing hero signals (eyebrow, two buttons, note), scan and breathe animations, illustrative Company 01 data, dark mode left secondary text navy on navy | 116 visible words, 9 links and buttons, 1 section, one headline, one sentence, one primary action plus one quiet link, dated real Company Zero numbers (8 departments, 103 open quests, 10 blocked, 0 decisions waiting), no animation, dark mode re-points the tokens; measured at 375px: no horizontal overflow, minimum text 12px, primary target 48px, quiet link 44px, zero console errors; token gate 35 allowlist entries and 3 gates clean | `screenshots/summon-landing-before-desktop-20260917.png`, `screenshots/summon-landing-before-mobile-20260917.png`, `screenshots/summon-landing-after-desktop-20260917.png`, `screenshots/summon-landing-after-mobile-20260917.png`. Shapeable sitewide rescan NOT run: shapeable.art has no node_modules on this machine and the disk has 20 GB free, so no score is claimed. Deploy is Adam's call (`vercel --prod` from apps/landing). |
