...
export function ProjectDetail() {
 ...
 <div className="inline-flex items-center gap-2 rounded-full border border-(--destructive)/30 bg-(--status-task-blocked)/10 px-3 py-1 text-(length:--text-micro) font-medium uppercase tracking-(--tracking-caps) text-(--destructive) dark:text-(--destructive)">
 <span className="h-2 w-2 rounded-full bg-(--status-task-blocked)/70"/>
