...
export function PipelineSettings() {
 ...
 body: error instanceof Error ? error.message : "Summon could not save the stage.",
 tone: "error",
 });
 },
 });
 ...
 ? error.message
 : "Summon could not save the stage secrets.",
 tone: "error",
 });
 },
 });
 ...
 body: error instanceof Error ? error.message : "Summon could not delete the stage.",
 tone: "error",
 });
 },
 });
 ...
 body: error instanceof Error ? error.message : "Summon could not update transition rules.",
 tone: "error",
 });
 },
 });
 ...
 The agent decides what the pieces are. Summon creates and tracks them.
 </p>
 </div>
 <ToggleSwitch
 ...
 <p className="flex items-center gap-1 text-(--status-task-todo) dark:text-(--status-task-todo)">
 ...
 {warningCount > 0 ? (
 <span className="inline-flex shrink-0 items-center gap-1 text-xs font-semibold text-(--status-task-todo) dark:text-(--status-task-todo)">
 ...
 <span className="mt-2 inline-flex items-center gap-1 text-xs font-medium text-(--status-task-todo) dark:text-(--status-task-todo)">
 ...
 "h-8 w-8",
 newEntriesDisabled &&
 "border-(--status-task-todo)/50 bg-(--status-task-todo)/10 text-(--status-task-todo) hover:bg-(--status-task-todo)/20 dark:text-(--status-task-todo)",
 )}
 ...
 This project has no saved workspace default. Summon will use the project fallback when automation runs.
 </p>
 ) : null}
 </FieldRow>
 ...
 <p className="mt-2 text-xs text-(--status-task-todo) dark:text-(--status-task-todo)">
