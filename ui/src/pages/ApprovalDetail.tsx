...
export function ApprovalDetail() {
 ...
 {showApprovedBanner && (
 <div className="border border-(--status-task-done)/30 dark:border-(--status-task-done)/40 bg-(--status-task-done)/10 rounded-lg px-4 py-3 animate-in fade-in zoom-in-95 duration-300">
 <div className="flex items-start justify-between gap-3">
 <div className="flex items-start gap-2">
 <div className="relative mt-0.5">
 <CheckCircle2 className="h-4 w-4 text-(--status-task-done) dark:text-(--status-task-done)" />
 <Sparkles className="h-3 w-3 text-(--status-task-done) dark:text-(--status-task-done) absolute -right-2 -top-1 animate-pulse" />
 </div>
 <div>
 <p className="text-sm text-(--status-task-done) dark:text-(--status-task-done) font-medium">Approval confirmed</p>
 <p className="text-xs text-(--status-task-done) dark:text-(--status-task-done)/90">
 ...
 size="sm"
 variant="outline"
 className="border-(--status-task-done)/30 dark:border-(--status-task-done)/50 text-(--status-task-done) dark:text-(--status-task-done) hover:bg-(--status-task-done)/10 dark:hover:bg-(--status-task-done)/30"
 ...
 <Button
 size="sm"
 className="bg-(--status-task-done) hover:bg-(--status-task-done) text-white"
