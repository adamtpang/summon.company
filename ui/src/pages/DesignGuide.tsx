...
export function DesignGuide() {
 ...
 <div className="flex items-center gap-2 flex-wrap">
 {[
 ["timer", "bg-(--status-task-in_progress)/10 text-(--status-task-in_progress) dark:bg-(--status-task-in_progress)/50 dark:text-(--status-task-in_progress)"],
 ["assignment", "bg-(--status-task-in_review)/10 text-(--status-task-in_review) dark:bg-(--status-task-in_review)/50 dark:text-(--status-task-in_review)"],
 ["on_demand", "bg-(--status-task-in_progress)/10 text-(--status-task-in_progress) dark:bg-(--status-task-in_progress)/50 dark:text-(--status-task-in_progress)"],
 ...
 <div className="space-y-3">
 {[
 { label: "Under budget (40%)", pct: 40, color: "bg-(--status-task-done)" },
 { label: "Warning (75%)", pct: 75, color: "bg-(--status-task-todo)" },
 { label: "Over budget (95%)", pct: 95, color: "bg-(--status-task-blocked)" },
 ].map(({ label, pct, color }) => (
 ...
 <div className="text-(--status-task-todo)">[12:00:05] WARN Rate limit approaching (80%)</div>
 ...
 <div className="text-(--status-task-in_progress)">[12:00:12] SYS Retrying connection in 5s...</div>
 ...
 <span className="text-(--status-task-in_progress) dark:text-(--status-task-in_progress)">Live</span>
 </div>
 </div>
 </Section>
