...
export function CompanyAccess() {
 ...
 <div className="rounded-xl border border-(--status-task-todo)/40 px-4 py-3 text-sm text-(--status-task-todo) dark:text-(--status-task-todo)">
...
export function CompanyAccessLegacyRoute() {
 ...
 <p className="text-sm text-muted-foreground">
 Core Summon keeps enforcing company boundaries and any existing restrictive policy data, but editing advanced permissions requires an installed extension.
 </p>
 {errorMessage ? (
