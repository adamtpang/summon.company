...
export function MissingUserSecretsBanner({
 ...
 <div
 className={
 "rounded-md border border-(--status-task-todo)/40 bg-(--status-task-todo)/5 p-3 text-xs text-(--status-task-todo) dark:text-(--status-task-todo)" +
 (className ? ` ${className}` : "")
 }
 >
 ...
 className="flex items-center justify-between gap-2 rounded border border-(--status-task-todo)/30 bg-background/40 px-2 py-1"
 >
