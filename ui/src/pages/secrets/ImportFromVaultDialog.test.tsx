...
describe("ImportFromVaultDialog", () => {
  ...
  it("blocks import when a review row collides with an existing Summon secret", async () => {
    ...
    expect(document.body.textContent?.toLowerCase()).toContain("a summon secret already uses this");
