...
export function IssueDetail() {
 ...
 {activePauseHold && (
 <div className="rounded-md border border-(--status-task-todo)/35 bg-(--status-task-todo)/10 p-3 text-sm text-(--status-task-todo) dark:text-(--status-task-todo)">
 ...
 className="inline-flex items-center gap-1 rounded-full bg-(--status-task-in_review)/10 border border-(--status-task-in_review)/30 px-2 py-0.5 text-(length:--text-nano) font-medium text-(--status-task-in_review) dark:text-(--status-task-in_review) shrink-0 hover:bg-(--status-task-in_review)/20 transition-colors"
 ...
 <Badge variant="outline"
 className="border-(--status-task-todo)/40 bg-(--status-task-todo)/10 text-(length:--text-nano) text-(--status-task-todo) dark:text-(--status-task-todo)"
 ...
 <Badge variant="outline"
 className="border-(--status-task-in_progress)/40 bg-(--status-task-in_progress)/10 text-(length:--text-nano) text-(--status-task-in_progress) dark:text-(--status-task-in_progress)"
 ...
 className="border-(--status-task-todo)/60 bg-(--status-task-todo)/15 text-(length:--text-nano) text-(--status-task-todo) dark:text-(--status-task-todo)"
 ...
 >
 {copied ? <Check className="h-4 w-4 text-(--status-task-done)" /> : <Copy className="h-4 w-4" />}
 </Button>
 <Button
 variant="ghost"
 size="icon-xs"
 ...
 <p key={warning.code} className="text-xs text-(--status-task-todo) dark:text-(--status-task-todo)">
 {warning.message}
 </p>
 ))}
 </div>
