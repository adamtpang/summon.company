...
"flex min-w-0 flex-1 items-start gap-2 no-underline text-inherit transition-colors",
 ...
 <span className="mt-0.5 shrink-0 rounded-md bg-(--status-task-blocked)/20 p-1.5 sm:mt-0">
...
"flex min-w-0 flex-1 items-start gap-2 no-underline text-inherit transition-colors",
 ...
 <Button
 size="sm"
 className="h-8 bg-(--status-task-done) px-3 text-white hover:bg-(--status-task-done)"
 onClick={onApprove}
 disabled={isPending}
 >
 Approve
...
"flex w-full items-center justify-between rounded-sm px-2 py-1.5 text-sm",
 ...
 className="flex flex-1 cursor-pointer items-center gap-3 no-underline text-inherit"
 >
 <AlertTriangle className="h-4 w-4 shrink-0 text-(--status-task-todo)"/>
 <span className="text-sm">
 Budget at{""}
