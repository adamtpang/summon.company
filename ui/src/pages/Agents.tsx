...
export function Agents() {
 ...
 <AlertTriangle className="h-3.5 w-3.5 text-(--status-task-todo)" aria-label="Invalid reporting chain" />
 ) : (
...
function OrgTreeNode({
 ...
 >
 {hasInvalidOrgChain ? (
 <AlertTriangle className="h-3.5 w-3.5 shrink-0 text-(--status-task-todo)" aria-label="Invalid reporting chain" />
 ) : (
...
function LiveRunIndicator({
 ...
 <span className="text-(length:--text-micro) font-medium text-(--status-task-in_progress) dark:text-(--status-task-in_progress)">
