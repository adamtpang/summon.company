...
export function HermesGatewayConfigFields({
  ...
  return (
    <>
      <Field
        label="API base URL"
        hint="Hermes API server base URL that Summon can reach, such as http://127.0.0.1:8642 or a private HTTPS URL. Default dashboard root/chat URLs such as http://127.0.0.1:9119/chat are accepted and map to /api."
      >
        <DraftInput
          value={apiBaseUrl}
      ...
      <Field
        label="Summon API URL"
        hint="Optional Summon API URL reachable by the Hermes host. This is not a credential."
      >
        <DraftInput
