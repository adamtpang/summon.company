...
export function FrontmatterPanel({
 ...
 <Badge variant="outline" className="gap-1 text-(--status-task-todo)" data-testid="frontmatter-warning-chip">
...
function FieldWarning({ message }: { message: string }) {
 return (
 <p className="mt-1 flex items-center gap-1 text-xs text-(--status-task-todo)">
...
function FieldsForm({
 ...
 <p className="mt-1 text-xs text-(--status-task-todo)">
