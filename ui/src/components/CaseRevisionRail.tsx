...
function CaseDocumentDiffModal({
 ...
 <span className="rounded-full border border-(--destructive)/30 bg-(--status-task-blocked)/10 px-2 py-0.5 text-(length:--text-nano) font-medium uppercase tracking-(--tracking-caps) text-(--destructive)">Old</span>
 ...
 <div className="flex items-center gap-2">
 <span className="rounded-full border border-(--status-task-done)/30 bg-(--status-task-done)/10 px-2 py-0.5 text-(length:--text-nano) font-medium uppercase tracking-(--tracking-caps) text-(--status-task-done)">New</span>
