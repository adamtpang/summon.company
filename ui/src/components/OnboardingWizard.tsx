...
export function OnboardingWizard() {
 ...
 <span className="flex items-center gap-1 shrink-0 text-xs font-medium text-(--status-task-done) dark:text-(--status-task-done)">
 ...
 <div className="mt-2 rounded-md border border-(--status-task-todo)/60 bg-(--status-task-todo)/40 px-2.5 py-2 space-y-1.5">
 ...
 <p className="text-(length:--text-micro) text-(--status-task-todo) dark:text-(--status-task-todo)">
