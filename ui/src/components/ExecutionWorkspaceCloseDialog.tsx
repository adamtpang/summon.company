...
export function ExecutionWorkspaceCloseDialog({
 ...
 artifacts. Summon keeps the workspace record and task history, but removes it from active workspace views.
 </DialogDescription>
 </DialogHeader>
 ...
 <li key={warning} className="break-words rounded-lg border border-(--status-task-todo)/20 bg-(--status-task-todo)/5 px-3 py-2">
 {warning}
 </li>
 ))}
 </ul>
 ...
 <div className="rounded-xl border border-(--status-task-todo)/20 bg-(--status-task-todo)/5 px-4 py-3 text-sm text-muted-foreground">
