...
function getIconSpec(
 ...
 return { kind: "lucide", Icon: Loader2, color: "text-(--status-task-in_progress) dark:text-(--status-task-in_progress)", spin: true };
 }
 ...
 switch (action) {
 case "approval.created":
 return { kind: "lucide", Icon: CircleAlert, color: "text-(--status-task-todo) dark:text-(--status-task-todo)" };
 case "approval.approved":
 return { kind: "lucide", Icon: CircleCheck, color: "text-(--status-task-done) dark:text-(--status-task-done)" };
 case "approval.rejected":
 return { kind: "lucide", Icon: CircleSlash, color: "text-(--destructive)" };
 case "approval.revision_requested":
 return { kind: "lucide", Icon: PencilLine, color: "text-(--status-task-todo) dark:text-(--status-task-todo)", filled: true };
 }

 // Agent
 switch (action) {
 case "agent.created":
 return { kind: "lucide", Icon: UserPlus, color: "text-(--status-task-in_review) dark:text-(--status-task-in_review)" };
 case "agent.paused":
 ...
 return { kind: "lucide", Icon: FileText, color: "text-(--status-task-in_progress) dark:text-(--status-task-in_progress)" };
 }

 // Work product / artifact on issue
 if (action.startsWith("issue.work_product_")) {
 return { kind: "lucide", Icon: Package, color: "text-(--status-task-in_progress) dark:text-(--status-task-in_progress)" };
 }
