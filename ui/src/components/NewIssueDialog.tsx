...
export function NewIssueDialog() {
 ...
 <ShieldAlert className="ml-auto h-3.5 w-3.5 shrink-0 text-(--status-task-todo) dark:text-(--status-task-todo)" aria-label="Low-trust review agent" />
 ) : null}
 </>
 );
 }}
 ...
 <div className="rounded-md border border-(--status-task-todo)/60 bg-(--status-task-todo)/10 px-2 py-1.5 text-(length:--text-micro) text-(--status-task-todo) dark:border-(--status-task-todo)/70 dark:text-(--status-task-todo)">
 ...
 className="mx-4 mb-2 flex items-start gap-2 rounded-md border border-(--status-task-todo)/70 bg-(--status-task-todo)/90 px-3 py-2 text-xs text-(--status-task-todo) dark:border-(--status-task-todo)/40 dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)"
 >
 <Flag className="mt-0.5 h-3.5 w-3.5 shrink-0 text-(--status-task-todo) dark:text-(--status-task-todo)" />
 ...
 className="mx-4 mb-2 flex items-start gap-2 rounded-md border border-(--status-task-todo)/70 bg-(--status-task-todo)/90 px-3 py-2 text-xs text-(--status-task-todo) dark:border-(--status-task-todo)/40 dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)"
 >
 <ShieldAlert className="mt-0.5 h-3.5 w-3.5 shrink-0 text-(--status-task-todo) dark:text-(--status-task-todo)" />
 <span className="leading-snug">
