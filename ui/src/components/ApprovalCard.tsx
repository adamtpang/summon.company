...
function statusIcon(status: string) {
 if (status === "approved") return <CheckCircle2 className="h-3.5 w-3.5 text-(--status-task-done) dark:text-(--status-task-done)" />;
 if (status === "rejected") return <XCircle className="h-3.5 w-3.5 text-(--destructive)" />;
 if (status === "revision_requested") return <Clock className="h-3.5 w-3.5 text-(--status-task-todo) dark:text-(--status-task-todo)" />;
 if (status === "pending") return <Clock className="h-3.5 w-3.5 text-(--status-task-todo) dark:text-(--status-task-todo)" />;
 return null;
}
