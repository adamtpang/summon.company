...
export function DocumentAnnotationLayer({
 ...
 isResolved
 ? "bg-(--status-task-todo)/10 outline outline-1 outline-dashed outline-offset-0 outline-yellow-700/45 dark:outline-yellow-200/45"
 : isStale
 ? "bg-(--status-task-todo)/10 outline outline-2 outline-dashed outline-offset-0 outline-yellow-700/65 dark:bg-(--status-task-todo) dark:outline-yellow-200/70"
 : isFocused
 ? "bg-(--status-task-todo) outline outline-2 outline-offset-0 outline-yellow-700/85 shadow-(--shadow-extract-6) dark:bg-(--status-task-todo) dark:outline-yellow-200/85"
 : "bg-(--status-task-todo)/10 dark:bg-(--status-task-todo)",
 )}
 style={{
 top: rect.top,
 left: rect.left,
 ...
 isHovered && "bg-(--status-task-todo)/40 ",
 ...
 aria-hidden="true"
 data-thread-id={rect.threadId}
 className="paperclip-doc-annotation-tail pointer-events-none absolute inline-flex items-center justify-center rounded-sm bg-(--status-task-todo)/95 text-(--status-task-todo) shadow-sm dark:bg-(--status-task-todo)/90 dark:text-(--status-task-todo)"
 style={{
