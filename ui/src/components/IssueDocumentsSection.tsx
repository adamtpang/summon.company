 ...
 */
 ...
 id="document-plan"
 className={cn(
 "rounded-lg border border-(--status-task-todo)/30 bg-(--status-task-todo)/5 p-3 transition-colors duration-1000",
 highlightDocumentKey === "plan" && "border-primary/50 bg-primary/5",
 )}
 >
 <div className="mb-2 flex items-center gap-2">
 <FileText className="h-4 w-4 text-(--status-task-todo)" />
 <Badge variant="outline" className="border-(--status-task-todo)/30 font-mono text-(length:--text-nano) uppercase tracking-(--tracking-eyebrow) text-(--status-task-todo) dark:text-(--status-task-todo)">
 PLAN
 </Badge>
 </div>
 ...
 isLocked && "text-(--status-task-todo) hover:text-(--status-task-todo) dark:text-(--status-task-todo) dark:hover:text-(--status-task-todo)",
 )}
 ...
 <span title="Locked document" aria-label="Locked document" className="inline-flex h-6 w-6 items-center justify-center text-(--status-task-todo) dark:text-(--status-task-todo)">
 ...
 <div className="rounded-md border border-(--status-task-todo)/30 bg-(--status-task-todo)/5 px-3 py-3">
 ...
 <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
 <div className="space-y-1">
 <p className="text-sm font-medium text-(--status-task-todo) dark:text-(--status-task-todo)">Out of date</p>
 <p className="text-xs text-muted-foreground">
