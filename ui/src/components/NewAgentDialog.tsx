...
export function NewAgentDialog() {
 ...
 <p className="text-sm text-muted-foreground">
 Choose the runtime Summon should start or resume directly.
 </p>
 </div>
 ...
 >
 {opt.recommended && (
 <Badge variant="ghost" className="absolute -top-1.5 right-1.5 bg-(--status-task-done) text-white text-(length:--text-nano) font-semibold px-1.5 leading-none">
 Recommended
 </Badge>
 )}
 ...
 <p className="text-sm text-muted-foreground">
 Generate a one-time onboarding prompt that any compatible agent can use to request access, wait for approval, and claim its Summon API key.
 </p>
 </div>
 </div>
