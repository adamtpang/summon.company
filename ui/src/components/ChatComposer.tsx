...
export const ChatComposer = forwardRef<ChatComposerHandle, ChatComposerProps>(function ChatComposer(
 ...
 isAsk &&
 "border-(--status-task-in_progress)/55 bg-(--status-task-in_progress)/50 focus-within:border-(--status-task-in_progress)/70 dark:border-(--status-task-in_progress)/50 dark:bg-(--status-task-in_progress)/[0.07]",
 isPlanning &&
 "border-(--status-task-todo)/55 bg-(--status-task-todo)/50 focus-within:border-(--status-task-todo)/70 dark:border-(--status-task-todo)/50 dark:bg-(--status-task-todo)/[0.07]",
