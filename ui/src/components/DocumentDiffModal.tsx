...
export function DocumentDiffModal({
 ...
 <Badge variant="outline"className="border-(--destructive)/30 bg-(--status-task-blocked)/10 text-(length:--text-nano) uppercase tracking-wider text-(--destructive)">Old</Badge>
 <Select
 ...
 <div className="flex items-center gap-2">
 <Badge variant="outline"className="border-(--status-task-done)/30 bg-(--status-task-done)/10 text-(length:--text-nano) uppercase tracking-wider text-(--status-task-done)">New</Badge>
 <Select
