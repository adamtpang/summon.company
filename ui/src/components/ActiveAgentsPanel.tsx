...
const AgentRunCard = memo(function AgentRunCard({
 ...
 isActive
 ? "border-(--status-task-in_progress)/25 bg-(--status-task-in_progress)/[0.04] shadow-(--shadow-extract-1)"
 ...
 isActive ? "text-(--status-task-in_progress) dark:text-(--status-task-in_progress)" : "text-muted-foreground hover:text-foreground",
 )}
