...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* bg-transparent: let the glass DialogContent show through (law 13 —
            the palette is an elevation surface). Standalone Command usages keep
            their opaque bg-popover. */}
