...
export function BlockedInboxView({
 ...
 role="alert"
 className="flex flex-col gap-2 rounded-md border border-(--status-task-todo)/70 bg-(--status-task-todo)/90 p-4 text-(--status-task-todo) dark:border-(--status-task-todo)/40 dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)"
 >
 ...
 variant="outline"
 size="sm"
 className="h-7 shrink-0 border-(--status-task-todo)/70 bg-white/40 text-(--status-task-todo) hover:bg-white/70 dark:bg-(--status-task-todo)/20 dark:text-(--status-task-todo)"
 ...
 >
 <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-(--status-task-done)/10 text-(--status-task-done) dark:bg-(--status-task-done)/15 dark:text-(--status-task-done)">
