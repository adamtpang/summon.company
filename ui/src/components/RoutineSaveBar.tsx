...
export function RoutineSaveBar({
 ...
 saveConflict
 ? "border-(--status-task-todo)/30 bg-(--status-task-todo)/5"
 : "border-border bg-background/95",
 )}
 >
 {saveConflict ? (
 <div className="flex items-center gap-2 text-sm text-(--status-task-todo) dark:text-(--status-task-todo)">
 ...
 >
 <span className="h-1.5 w-1.5 rounded-full bg-(--status-task-todo)" />
