...
const progressSegmentClasses: Record<IssueStatus, string> = {
 ...
 todo:"bg-(--status-task-in_progress)",
 in_progress:"bg-(--status-task-todo)",
 in_review:"bg-(--status-task-in_review)",
 done:"bg-(--status-task-done)",
 blocked:"bg-(--status-task-blocked)",
 cancelled:"bg-(--accent)",
};
...
"flex w-full items-center justify-between rounded-sm px-2 py-1.5 text-sm",
 ...
 className="inline-flex items-center rounded-full border border-(--status-task-todo)/45 bg-(--status-task-todo)/60 px-1.5 py-0.5 text-(length:--text-nano) font-medium text-(--status-task-todo) hover:bg-(--status-task-todo)/80 dark:border-(--status-task-todo)/35 dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)"
 ...
 <Badge variant="outline"className="ml-1.5 border-(--status-task-todo)/40 bg-(--status-task-todo)/10 px-1.5 text-(length:--text-nano) text-(--status-task-todo) dark:text-(--status-task-todo)">
 {issueBadge}
 </Badge>
 )
 ) : null}
 ...
 className="ml-1.5 border-(--status-task-todo)/45 bg-(--status-task-todo)/60 px-1.5 text-(length:--text-nano) text-(--status-task-todo) dark:border-(--status-task-todo)/35 dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)"
