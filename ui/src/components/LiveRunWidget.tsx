...
export function LiveRunWidget({ issueId, companyId }: LiveRunWidgetProps) {
 ...
 return (
 <div className="overflow-hidden rounded-xl border border-(--status-task-in_progress)/25 bg-background/80 shadow-(--shadow-extract-11)">
 <div className="border-b border-border/60 bg-(--status-task-in_progress)/[0.04] px-4 py-3">
 <div className="text-xs font-semibold uppercase tracking-(--tracking-caps) text-(--status-task-in_progress) dark:text-(--status-task-in_progress)">
 Live Runs
 </div>
 ...
 className="inline-flex items-center rounded-full border border-border/70 bg-background/70 px-2 py-1 font-mono hover:border-(--status-task-in_progress)/30 hover:text-foreground"
 >
 {run.id.slice(0, 8)}
 </Link>
 ...
 className="inline-flex items-center gap-1 rounded-full border border-(--destructive)/20 bg-(--status-task-blocked)/[0.06] px-2.5 py-1 text-(length:--text-micro) font-medium text-(--destructive) transition-colors hover:bg-(--status-task-blocked)/[0.12] dark:text-(--destructive) disabled:opacity-50"
 >
 ...
 <Link
 to={`/agents/${run.agentId}/runs/${run.id}`}
 className="inline-flex items-center gap-1 rounded-full border border-border/70 bg-background/70 px-2.5 py-1 text-(length:--text-micro) font-medium text-(--status-task-in_progress) transition-colors hover:border-(--status-task-in_progress)/30 hover:text-(--status-task-in_progress) dark:text-(--status-task-in_progress)"
 >
 Open run
