...
function StatusBadge({ status }: { status: AcceptedPlanDecompositionSummary["status"] }) {
 if (status === "completed") {
 return (
 <span className="inline-flex items-center gap-1 rounded-sm border border-(--status-task-done)/50 bg-(--status-task-done)/10 px-2 py-0.5 text-(length:--text-micro) font-medium text-(--status-task-done) dark:text-(--status-task-done)">
 ...
 return (
 <span className="inline-flex items-center gap-1 rounded-sm border border-(--status-task-todo)/50 bg-(--status-task-todo)/10 px-2 py-0.5 text-(length:--text-micro) font-medium text-(--status-task-todo) dark:text-(--status-task-todo)">
...
export function IssuePlanDecompositionsSection({
 ...
 <span
 className="inline-flex items-center gap-1 rounded-sm border border-(--status-task-in_progress)/40 bg-(--status-task-in_progress)/10 px-1.5 py-0.5 text-(length:--text-nano) font-medium text-(--status-task-in_progress) dark:text-(--status-task-in_progress)"
