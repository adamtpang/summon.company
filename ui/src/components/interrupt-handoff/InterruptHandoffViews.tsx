...
export function ComposerHandoffPreviewRow({
 ...
 preview.tone === "warn" ? "text-(--status-task-todo) dark:text-(--status-task-todo)" : "text-muted-foreground",
 )}
...
export function ComposerMentionCoach({
 ...
 return (
 <div
 className="flex items-center gap-2 rounded-md border border-(--status-task-todo)/40 bg-(--status-task-todo)/70 px-2 py-1.5 text-xs text-(--status-task-todo) dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)"
 ...
 type="button"
 onClick={onInsert}
 className="shrink-0 rounded border border-(--status-task-todo)/50 px-1.5 py-0.5 font-medium hover:bg-(--status-task-todo)/60 dark:hover:bg-(--status-task-todo)/20"
 ...
 type="button"
 onClick={onDismiss}
 className="shrink-0 rounded p-0.5 hover:bg-(--status-task-todo)/60 dark:hover:bg-(--status-task-todo)/20"
...
export function AssigneeRunningBanner({
 ...
 className={cn(
 "flex items-start gap-1.5 rounded-md border border-(--status-task-todo)/40 bg-(--status-task-todo)/70 px-2 py-1.5 text-xs text-(--status-task-todo) dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)",
 className,
 )}
 >
...
export function InterruptAssignConfirm({
 ...
 className="space-y-2 rounded-md border border-(--status-task-todo)/40 bg-(--status-task-todo)/70 p-2 text-xs text-(--status-task-todo) dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)"
 >
 <div className="flex items-start gap-1.5">
 <AlertTriangle className="mt-0.5 h-3.5 w-3.5 shrink-0" aria-hidden />
 <div className="min-w-0 flex-1 space-y-1">
 <p className="font-medium">{copy.confirmTitle}</p>
 <p className="flex flex-wrap items-center gap-1 text-(--muted-foreground) dark:text-(--muted-foreground)">
 ...
 type="button"
 onClick={onCancel}
 className="rounded border border-(--status-task-todo)/50 px-2 py-0.5 font-medium hover:bg-(--status-task-todo)/60 dark:hover:bg-(--status-task-todo)/20"
 >
 {copy.cancelAction}
 </button>
 <button
 ...
 className="rounded bg-(--status-task-todo) px-2 py-0.5 font-medium text-white hover:bg-(--status-task-todo)/80 dark:bg-(--status-task-todo) dark:hover:bg-(--status-task-todo)"
 >
 {copy.confirmAction}
 </button>
 </div>
