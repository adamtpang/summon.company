...
export function PipelineHealthBar({
 ...
 className={cn(
 "rounded-md border border-(--status-task-todo)/30 bg-(--status-task-todo)/10 px-3 py-2.5 text-(--status-task-todo) dark:border-(--status-task-todo)/30 dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)",
 className,
 )}
 >
 ...
 {overflow > 0 ? (
 <p className="mt-1.5 pl-6 text-xs text-(--muted-foreground) dark:text-(--muted-foreground)">
...
export function StageHealthWarnings({
 ...
 className={cn(
 "rounded-md border border-(--status-task-todo)/30 bg-(--status-task-todo)/10 px-3 py-2.5 text-sm text-(--status-task-todo) dark:border-(--status-task-todo)/30 dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)",
 className,
 )}
 >
 <h2
