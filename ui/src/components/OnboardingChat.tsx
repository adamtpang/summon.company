...
export function OnboardingChat({
 ...
 {isPlan && (
 <span className="inline-flex items-center gap-0.5 text-(length:--text-nano) text-(--status-task-done) dark:text-(--status-task-done) font-medium">
 ...
 <div className="rounded-md border border-(--status-task-done)/30 bg-(--status-task-done)/5 px-3 py-3 mb-3">
 <div className="flex items-center justify-between gap-3">
 <div className="flex items-center gap-2">
 <CheckCircle2 className="h-4 w-4 text-(--status-task-done) shrink-0" />
 <div>
