...
export const kanbanColumnTones: Partial<Record<IssueStatus, typeof defaultKanbanColumnTone>> = {
 ...
 railOver:"bg-muted/50 ring-1 ring-(--border)/25",
 header:"text-muted-foreground",
 count:"text-muted-foreground/60",
 body:"bg-muted/30 ring-1 ring-inset ring-border/50",
 bodyOver:"bg-muted/50 ring-1 ring-inset ring-(--border)/25",
 card:"",
 },
 todo: {
 rail:"border-(--status-task-todo)/25 bg-(--status-task-todo)/60 ",
 railOver:"bg-(--status-task-todo)/70 ring-1 ring-(--status-task-todo)/25 ",
 header:"text-(--status-task-todo) dark:text-(--status-task-todo)",
 count:"text-(--muted-foreground) dark:text-(--muted-foreground)",
 body:"bg-(--status-task-todo)/45 ring-1 ring-inset ring-(--status-task-todo)/15 ",
 bodyOver:"bg-(--status-task-todo)/70 ring-1 ring-inset ring-(--status-task-todo)/25 ",
 card:"",
 },
 in_progress: {
 rail:"border-(--status-task-in_progress)/25 bg-(--status-task-in_progress)/60 ",
 railOver:"bg-(--status-task-in_progress)/70 ring-1 ring-(--status-task-in_progress)/25 ",
 header:"text-(--status-task-in_progress) dark:text-(--status-task-in_progress)",
 count:"text-(--status-task-in_progress)/65 dark:text-(--status-task-in_progress)/65",
 body:"bg-(--status-task-in_progress)/45 ring-1 ring-inset ring-(--status-task-in_progress)/15 ",
 bodyOver:"bg-(--status-task-in_progress)/70 ring-1 ring-inset ring-(--status-task-in_progress)/25 ",
 card:"",
 },
 blocked: {
 rail:"border-(--destructive)/25 bg-(--destructive)/60",
 railOver:"bg-(--destructive)/70 ring-1 ring-(--destructive)/25",
 header:"text-(--destructive) dark:text-(--destructive)",
 count:"text-(--destructive)/65 dark:text-(--destructive)/65",
 body:"bg-(--destructive)/45 ring-1 ring-inset ring-(--destructive)/15",
 bodyOver:"bg-(--destructive)/70 ring-1 ring-inset ring-(--destructive)/25",
 card:"",
 },
 in_review: {
 rail:"border-(--status-task-in_review)/25 bg-(--status-task-in_review)/60 ",
 railOver:"bg-(--status-task-in_review)/70 ring-1 ring-(--status-task-in_review)/25 ",
 header:"text-(--status-task-in_review) dark:text-(--status-task-in_review)",
 count:"text-(--status-task-in_review)/65 dark:text-(--status-task-in_review)/65",
 body:"bg-(--status-task-in_review)/45 ring-1 ring-inset ring-(--status-task-in_review)/15 ",
 bodyOver:"bg-(--status-task-in_review)/70 ring-1 ring-inset ring-(--status-task-in_review)/25 ",
 card:"",
 },
 done: {
 rail:"border-(--status-task-done)/25 bg-(--status-task-done)/60 ",
 railOver:"bg-(--status-task-done)/70 ring-1 ring-(--status-task-done)/25 ",
 header:"text-(--status-task-done) dark:text-(--status-task-done)",
 count:"text-(--status-task-done)/65 dark:text-(--status-task-done)/65",
 body:"bg-(--status-task-done)/45 ring-1 ring-inset ring-(--status-task-done)/15 ",
 bodyOver:"bg-(--status-task-done)/70 ring-1 ring-inset ring-(--status-task-done)/25 ",
 card:"",
 },
 cancelled: {
 rail:"border-(--border) bg-muted/25 opacity-80 dark:border-(--border)/70 dark:bg-(--card)/20",
 railOver:"bg-muted/45 opacity-90 ring-1 ring-(--border)/25 dark:bg-(--card)/35",
 header:"text-muted-foreground/80",
 count:"text-muted-foreground/50",
 body:"bg-muted/25 ring-1 ring-inset ring-border/50",
 bodyOver:"bg-muted/45 ring-1 ring-inset ring-(--border)/25",
...
"block cursor-grab active:cursor-grabbing transition-shadow",
 ...
 className="border-(--status-task-todo)/45 bg-(--status-task-todo)/60 px-1.5 text-(length:--text-nano) text-(--status-task-todo) dark:border-(--status-task-todo)/35 dark:bg-(--status-task-todo)/10 dark:text-(--status-task-todo)"
 ...
 {isLive && (
 <span className="inline-flex shrink-0 items-center gap-1 text-(length:--text-nano) font-medium text-(--status-task-in_progress) dark:text-(--status-task-in_progress)">
