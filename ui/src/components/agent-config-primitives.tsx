...
export const help: Record<string, string> = {
 ...
 workspaceStrategy: "How Summon should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
 ...
 bootstrapPrompt: "Only sent when Summon starts a fresh session. Use this for stable setup guidance that should not be repeated on every heartbeat.",
 payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Summon adds its standard wake and workspace fields.",
...
export function ToggleField({
 ...
 {/* Gallery feedback r3: was a hand-rolled h-5 w-9 pill with a bg-(--status-task-done)
