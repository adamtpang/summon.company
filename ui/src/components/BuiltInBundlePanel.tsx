 ...
 * that one resource to Summon's newest shipped default without touching
...
function resourceActionCopy(
  ...
  if (resource.stockStatus === "stock_update_available") {
    return {
      ...
      body: `You haven't edited this, so Summon will replace it with the newer shipped version. Nothing you customized is affected, and your adapter credentials and settings are not touched.`,
      confirmLabel: "Update",
      triggerLabel: "Update",
    };
  }
  if (resource.stockStatus === "operator_modified") {
    return {
      ...
      body: `This replaces your edited version with Summon's current default. Your edits can't be recovered. Adapter credentials and settings are not touched.`,
  ...
  if (resource.stockStatus === "missing") {
    return {
      ...
      body: `This resource is missing. Summon will recreate it from the shipped default. Adapter credentials and settings are not touched.`,
              ...
              <>
                {onRunRoutine && (
                  <ConfirmActionButton
                    ...
                    body="Summon will create one routine task now. This does not enable the weekly schedule or turn on background work."
                ...
                {scheduleEnabled
                  ? onDisableSchedule && (
                    <ConfirmActionButton
                      ...
                      body="Summon will stop future scheduled Reflection Coach runs. Manual Run once remains available."
                  ...
                  : onEnableSchedule && (
                    <ConfirmActionButton
                      ...
                      body="Summon will allow Reflection Coach to create routine tasks on the weekly schedule. It can spend tokens when those tasks run."
