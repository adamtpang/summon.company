...
const dashboard: DashboardSummary = {
  ...
  finance: {
    ...
    stripeMode: null,
    revenueAsOf: null,
    revenueFreshness: "unavailable",
    nextRevenueSyncAt: null,
    currency: null,
    revenueCents: null,
    revenueCoverage: "unavailable",
    arrCents: null,
    arrCurrency: null,
    ...
    expenseEvidenceSource: "ai_only",
    expenseCents: 900,
    expenseCurrency: "usd",
    expenseCoverage: "summon_ai_costs_only",
    profitCents: null,
    profitStatus: "unproven",
    availableCashCents: null,
    pendingCashCents: null,
    cashStatus: "unavailable",
    monthlyBurnCents: null,
    runwayMonths: null,
    runwayStatus: "unproven",
  },
  pendingApprovals: 1,
  budgets: {
    activeIncidents: 0,
